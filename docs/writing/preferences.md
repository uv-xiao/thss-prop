...
- When using agentic/LLM evidence in the introduction, separate evidence types: McKinsey/Anthropic support broad enterprise/software-engineering trend; Siemens/Synopsys support EDA vendor trend; METR and agentic software/EDA/compiler papers support research capability and risk; none alone proves complete autonomous chip design.
