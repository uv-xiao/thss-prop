...
// 导入并重导出所有公共符号
#import "pku-topic-template-package/lib/config.typ": appendix, 字体, 字号, 引用记号
#import "pku-topic-template-package/lib/utils.typ": chinesenumbering
#import "pku-topic-template-package/lib/components.typ": (
  as-booktab, booktab, chineseoutline, codeblock, listoffigures,
)
#import "pku-topic-template-package/lib/styles.typ": (
  sym-bullet, sym-square-filled, sym-square-filled-rotated,
)

// 高级用户 API：导出内部计数器和状态，用于自定义章节编号等场景
// 注意：这些是内部实现细节，未来版本可能会有变化
#import "pku-topic-template-package/lib/config.typ": (
  appendixcounter, chaptercounter, partcounter, skippedstate,
)

// 内部使用的模块
#import "pku-topic-template-package/lib/pages.typ"
#import "pku-topic-template-package/lib/styles.typ"
