...
第一章章标题固定为“引言”。不要改成“研究背景与问题提出”或更长的说明性标题；具体论证功能通过 1.1-1.7 的小节标题和两张总览图体现。
...
- 本节不要使用表格列出核心问题、接口、章节和代表工作。三问题应通过连续论证自然收束，保持博士开题报告的学术叙事流畅性。结构映射交给 1.7 的文字和图示完成。
...
- 1.6 或 1.7 附近需要新绘制一张“研究问题与章节映射”结构图。
